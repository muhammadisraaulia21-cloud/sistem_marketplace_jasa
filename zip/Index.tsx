...
// 1. Struktur data untuk satu objek Jasa
interface Service {
    id: number;
    user_id: number; // Menambahkan user_id agar valid saat dicek di bawah
    title: string;
    description: string;
    price: number;
    user?: {
...
// 2. Struktur data untuk Properti (Props) Halaman Index
...
export default function Index({ auth, services = [] }: IndexProps) {
    // Memanggil helper delete bawaan InertiauseForm
        ...
        <AppLayout>
            ...
            <div className="px-4 py-6 sm:px-6 lg:px-8">
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-100">
                    ...
                    {/* Header: Judul dan Tombol Tambah Jasa */}
                    ...
                    {/* Logika Pengecekan: Jika Data Kosong vs Ada Isi */}
                    {services.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {services.map((service) => (
                                <div key={service.id} className="border border-gray-200 p-5 rounded-lg shadow-sm hover:shadow-md transition duration-300 bg-white flex flex-col justify-between">
                                    
                                    <div>
                                        {/* Menampilkan Nama Pemilik Jasa */}
                                    ...
                                    <div className="mt-4 pt-4 border-t">
                                        ...
                                        <button className="w-full bg-gray-900 text-white py-2 rounded-md hover:bg-gray-800 transition text-sm font-medium mb-2">
                                            Lihat Detail
                                        </button>

                                        {/* Tombol Hapus: Hanya muncul jika ID User Login cocok dengan User ID Pemilik Jasa */}
